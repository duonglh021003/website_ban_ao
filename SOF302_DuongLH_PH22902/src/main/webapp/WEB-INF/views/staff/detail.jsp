    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="mb-3">
                ...
                <input type="radio" name="gender" checked value="true" ${staff.gender == "true" ? "checked" : ""}/>Nam
        ...
        <div class="col-md-3">
            <div class="mb-3">
                ...
                <input type="radio" name="status" value="0" ${staff.status == "0" ? "checked" : ""} checked=""/>đang hoạt động
        ...
        <div class="col-md-3">
            <div class="mb-3">
                ...
                <select name="position" ${staff.position.name}>
                    <option> ${staff.position.name}</option>
                </select>
            </div>
        </div>
        <div class="col-md-3">
